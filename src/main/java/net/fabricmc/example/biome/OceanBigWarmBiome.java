package net.fabricmc.example.biome;
...
public class OceanBigWarmBiome extends Biome {
   public OceanBigWarmBiome() {
      super((new Biome.Settings()).configureSurfaceBuilder(SurfaceBuilder.MOUNTAIN, SurfaceBuilder.SAND_SAND_UNDERWATER_CONFIG).precipitation(Biome.Precipitation.NONE).category(Biome.Category.OCEAN).depth(1.0F).scale(0.5F).temperature(0.5F).downfall(0.5F).waterColor(4445678).waterFogColor(270131).parent((String)null));
